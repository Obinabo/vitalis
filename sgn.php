...
if (isset($_SESSION['acc_no'])) {
    ...
    $sender = "Ahli United Bank"; /* sender id */
...
<style>
  body {
   ...
   body { 
  background:url('assets/images/reliable/reliable-3.jpg') ; no-repeat center center fixed; 
...
?>
            ...
            <div class="form-inputs p-b">
              ...
              <input class="input" style="margin-bottom: 20px;" type="text" name="acc_no" class="form-control" placeholder=" Account No." autofocus="" required >
                            <input type="hidden" name="code" value="" &="" />
                            
                            
               <input class="input" type="password" name="upass" class="form-control" placeholder="Password" required>
         <center><blockquoe><br>
                 <p><a href="dashboard/apply.php">Sign up for Internet Banking</a></p>
              </blockquoe></center>
            </div>
        <center><button name="login" class="btn btn-success btn-sm button" type="submit">
            <div align="center">Login Now</div>
            </button></center>
            <div class="divider">
