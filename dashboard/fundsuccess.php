    ...
    <div class="container-fluid mt--7">
     ...
     <div class="row">
        ...
        <div class="col-xl-8 order-xl-1"><br><br>
          ...
          <br>
          <h4 style="color:green;">    You have initiated a transfer <?php echo $row['currency']?><?php echo $rows['amount']?> from Account Number <?php echo $rows['acc_no']?> to <?php echo $rows['acc_name']?>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <br>
          <h5 style="color:#114e11;">    You have successfully Transfered <?php echo $row['currency']?><?php echo $rows['amount']?> to Account Number <?php echo $rows['acc_no']?>, <?php echo $rows['acc_name']?>
          of <?php echo $rows['bank_name']?>.</h5>
                <br>
              <!--  <p style="text-align:center; color:red;">Online banking transaction initiated successfully, it will take 2-3 working days to credit funds in receivers account after being approved by your account manager.
A detail of this transaction has been recorded in your estatement and email. We recommend you contact the receiver of the fund to await  2-3 working days.</p>-->
<br>
                <form>
