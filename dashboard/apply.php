        ...
        <div class="col" >
          <div class="card shadow"  >
            <div class="card-header border-0">
                <img style="width: 250px;" src="../assets/img/brand/vitalisbank.png" alt="LOGO" data-default="placeholder" data-max-width="100" width="16%"></br><br>
              <h3 class="mb-0"><a href=""   class="btn btn-danger">Online Banking Application</a></h3>
            </div>
...
<hr>
			...
			<button id="btn1" class="btn btn-success"><a href="apply2.php" style="color:white;">Get Started Now</a></button>
			&nbsp;	&nbsp;	&nbsp;	&nbsp;	&nbsp;	<button id="btn1" class="btn btn-danger"><a href="../sgn.php" style="color:white;">Back to Login</a></button>
