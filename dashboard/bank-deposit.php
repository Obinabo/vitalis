...
<body paddingwidth='0' paddingheight='0' bgcolor='#d1d3d4'  style=' margin-left:5px; margin-right:5px; margin-bottom:0px; margin-top:0px;padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;' offset='0' toppadding='0' leftpadding='0'>
                            ...
                            <td align='left' valign='middle' width='200'>
                              <div class='contentEditableContainer contentImageEditable'>
                                <div class='contentEditable' >
                                 <center> <img src='https://vitalisfinances.com/assets/img/brand/blue.png' alt='' data-default='placeholder' data-max-width='120' width='118' height='50' > </center>
  ...
  <tr>
								<td width='400' valign='top' class='specbundle2'>
                                  <div class='contentEditableContainer contentImageEditable'>
                                    <div class='contentEditable' >
                                      <img class='banner' src='https://test.busymen.website/bankforce/dashboard/dollar.png' alt='featured image' data-default='placeholder' data-max-width='300' width='326' height='269' >
                                    </div>
                                  </div>
                                </td>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' align='center' valign='top'>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>Vitalis Finances INC</p>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
              ...
              <p> Bank Account No:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $bank_account; ?> 
               <p> Account Name:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $account_name; ?> 
                <p> Swift Code:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $swift_code; ?> 
                 ...
                 <input type="submit" name="ticket" class="btn btn-warning" value="OPEN DEPOSIT TICKET"><br>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <label class="form-control-label" for="input-username">Receiver (Customer Cash Deposit)</label>
