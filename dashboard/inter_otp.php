                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
	<br > 
     <h1 style='font-size:20px;font-weight:normal;color:black;line-height:19px;'>Dear $fname $lname,</h1><p style='font-size:17px;color:black;line-height:19px;'>Your transfer was successful! Below is the transaction summary.</p>								<h3>Transaction Alert</h3>
