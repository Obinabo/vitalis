...
public function updatet($id,$email,$bank_name,$acc_name,$acc_no,$amount,$date,$status,$swift,$type,$remarks)
	...
	/* paging */
        ...
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = "";
        $mail->Host = "test.busymen.website";
        $mail->Port = 587;
        $mail->AddAddress($email);
        $mail->Username = "info@test.busymen.website";
        $mail->Password = "busy@360";
        $mail->SetFrom('info@test.busymen.website', 'MARGON BANKING SCRIPT');
        $mail->AddReplyTo("info@test.busymen.website", "MARGON BANKING SCRIPT");
