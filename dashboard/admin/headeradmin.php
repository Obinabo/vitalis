...
<head>
  ...
  <!-- Favicon -->
  <link href="../../assets/img/brand/vitalis.png" rel="icon" type="image/png">
  <!-- Fonts -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="../../assets/img/brand/vitalisbank.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="">
                <img src="../../assets/img/brand/stabilizebank.png">
              </a>
            </div>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link " href="billing.php">
                 <i class='fas fa-lira-sign' style='font-size:18px;color:black'></i>Activate/Deactivate Billing Code
            </a>
          </li>
